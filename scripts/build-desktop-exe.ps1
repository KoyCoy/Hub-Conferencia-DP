...
$AppDist = Join-Path $DistRoot "CheckDaFolhaIA-Windows"
$ZipPath = Join-Path $DistRoot "CheckDaFolhaIA-Windows.zip"
$Csc = "C:\Windows\Microsoft.NET\Framework64\v4.0.30319\csc.exe"
$IconPath = Join-Path $RepoRoot "assets\icons\check-da-folha-ia.ico"
...
$ExePath = Join-Path $AppDist "CheckDaFolhaIA.exe"
...
if ($LASTEXITCODE -ne 0) {
  throw "Falha ao compilar CheckDaFolhaIA.exe"
}
...
Copy-Item -LiteralPath $IconPath -Destination (Join-Path $AppDist "check-da-folha-ia.ico") -Force
