...
Este e o caminho recomendado para usar o Check da Folha IA nos PCs da empresa sem depender de `.cmd`, PowerShell, GitHub Pages publico ou instalador com permissao de administrador.

## Ideia

Subir os arquivos estaticos do Check da Folha IA em uma pasta do SharePoint e abrir o `index.html` pelo Microsoft Edge ou Google Chrome.
...
O Windows cria um app `Check da Folha IA` no Menu Iniciar e ele abre em janela propria.
...
- `service-worker.js`
- `assets/icons/check-da-folha-ia-192.png`
- `assets/icons/check-da-folha-ia-512.png`
...
```text
Documentos Compartilhados / Check da Folha IA App
```

2. Envie para essa pasta todo o conteudo do pacote `dist/sharepoint/CheckDaFolhaIA-SharePoint.zip`.
